...
public class InfoContact extends AppCompatActivity {
    TextView tvNombreContact, tvNumeroContact, tvTipoPokemon; // Agregar TextView para mostrar el tipo
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTipoPokemon = findViewById(R.id.tvTipoPokemon); // Referencia al TextView para mostrar el tipo
        ...
        tipoActual = getIntent().getStringExtra("tipo"); // Obtener el tipo del intent
        ...
        String tipoPokemon= getIntent().getStringExtra("tipo"); // Obtener el tipo del intent
        ...
        tvTipoPokemon.setText(tipoPokemon); // Mostrar el tipo en el TextView
