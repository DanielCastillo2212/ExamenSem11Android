...
public class AgregarContacto extends AppCompatActivity {
    ...
    private EditText etTipo; // Nuevo EditText para el atributo tipo
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etTipo = findViewById(R.id.etTipo); // Referencia al nuevo EditText para el atributo tipo
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String tipo = etTipo.getText().toString(); // Obtener el valor del nuevo atributo tipo
                ...
                if (!nombre.isEmpty() && !numero.isEmpty()) {
                    ...
                    contact.setTipo(tipo); // Establecer el valor del atributo tipo
